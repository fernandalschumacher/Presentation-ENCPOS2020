...
\NormalTok{      fit3ar1}\OperatorTok{$}\NormalTok{theta,fit3ar1}\OperatorTok{$}\NormalTok{std.error) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{,}\DataTypeTok{col.names =} 
                 \KeywordTok{c}\NormalTok{(}\StringTok{'estimate'}\NormalTok{,}\StringTok{'std.error'}\NormalTok{,}\StringTok{'estimate'}\NormalTok{,}\StringTok{'std.error'}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\item
  ...
  Helen C. Sing, Daniel P. Redmond, Michael B. Russo \& Thomas J. Balkin
  (2003) Patterns of performance degradation and restoration during
  sleep restriction and subsequent recovery: a sleep dose-response
  study. Journal of Sleep Research 12, 1--12.
\item
  Schumacher, F. L., Matos, L. A., \& Lachos, V. H. (2020). Scale
  mixture of skew-normal linear mixed models with within-subject serial
  dependence. arXiv preprint arXiv:2002.01040.
\end{itemize}
