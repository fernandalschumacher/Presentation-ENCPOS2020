...
\begin{columns}
\column{.35\textwidth}
\center{\Large Full paper} \\
\href{https://arxiv.org/abs/2002.01040}{\includegraphics[ height=2.2cm, keepaspectratio=true]{qrcode.eps}}
\column{.65\textwidth}
\vspace{-.4cm}\center{\Large Acknowledgments} 
\\\includegraphics[ height=1.7cm, keepaspectratio=true]{imecc} \hspace{.5cm}
\includegraphics[ height=1.7cm, keepaspectratio=true]{logo-capes}
\end{columns}
...
\begin{flushright} 
\vspace{.01cm}
\includegraphics[ height=1cm, keepaspectratio=true]{contact}
\end{flushright}
\end{minipage}%
\hfill%
